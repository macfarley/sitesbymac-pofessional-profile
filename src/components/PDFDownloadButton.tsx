 ...
 *    - Always check currentY against pageHeight before adding content
 *    - Use consistent margin calculations across pages
 *    - Reset currentY to margin after addPage()
 * 
 * 2. Typography Hierarchy:
 *    - 18pt: Main heading (name)
 *    - 13pt: Section headers
 *    - 10pt: Body text and job titles
 *    - 9pt: Dates and secondary info
 *    - 8pt: Skills lists and compact content
 * 
 ...
 * 
 * 4. Bullet Point Indentation:
 *    Use 3mm indent for consistent bullet alignment
 *    Consider using actual bullet characters (•) for better appearance
 * 
 * 5. Professional Resume Best Practices:
 *    - Keep to 1-2 pages maximum
 *    - Use consistent spacing and fonts
 *    - Prioritize achievements over job descriptions
 *    - Include contact information on every page
 * 
 * 6. Performance Optimization:
 *    - Generate PDF programmatically (faster than DOM conversion)
 *    - Pre-calculate layouts to avoid redundant measurements
 *    - Use try-catch for graceful error handling
 * 
 * 7. Customization Ideas:
 *    - Add company logos or personal branding
 *    - Include QR codes for digital portfolio links
 *    - Generate different versions for different job types
