  ...
  return (
    <div className="min-h-screen bg-stone-100 dark:bg-gray-900">
      <div className="max-w-4xl mx-auto px-4 py-12 sm:py-20">
        ...
        {/* Contact Section */}
        <div className="bg-amber-100 dark:bg-gray-800 rounded-2xl shadow-xl p-8 sm:p-12 mb-12">
          ...
          <div className="space-y-6 max-w-md mx-auto">
            ...
            {/* Website */}
            <div className="text-center p-4 bg-amber-100 dark:bg-gray-700 rounded-xl">
        ...
        <div className="text-center">
          <div className="bg-amber-100 dark:bg-gray-800 rounded-2xl shadow-xl p-8 inline-block">
