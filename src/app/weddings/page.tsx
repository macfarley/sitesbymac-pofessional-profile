          ...
          <div className="space-y-6 max-w-md mx-auto">
            ...
            <div className="text-center p-4 bg-stone-50 dark:bg-gray-700 rounded-xl">
              ...
              <div className="mt-3">
                <a
                  href="/weddings/demo"
                  className="inline-flex items-center gap-2 text-lg font-semibold text-rose-600 dark:text-rose-400 hover:text-rose-700 dark:hover:text-rose-300 transition-colors"
                  aria-label="View weddings demo site"
                >
                  Demo Site
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">sitesbymac.dev/weddings/demo</p>
              </div>
            </div>
          </div>
        </div>
