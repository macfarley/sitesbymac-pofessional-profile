...
export default async function ProjectPage({ params }: ProjectPageProps) {
  ...
  return (
    <div className="min-h-screen bg-stone-100 dark:bg-gray-900">
      ...
      {/* Other Projects */}
      <div className="bg-amber-50 dark:bg-gray-800 py-16 px-4">
            ...
            {projects
              ...
              .map((otherProject) => (
                <Link
                  ...
                  className="group block bg-amber-50 dark:bg-gray-700 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow"
                >
                  <div className="p-6">
