                ...
                <div className="space-y-2">
                  ...
                  {project.githubUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="block px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-center"
                    >
                      Source Code
                    </a>
                  )}
            ...
            {projects
              ...
              .map((otherProject) => (
                <Link
                  ...
                  className="group block bg-white dark:bg-gray-700 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow"
                >
                  <div className="p-6">
